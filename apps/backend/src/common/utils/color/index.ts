 ...
 */
export function formatPaletteForLogging(palette: VibrantPalette): Record<string, string | null> {
  return {
    Vibrant: palette.Vibrant ? rgbToHex(palette.Vibrant.rgb) : null,
    LightVibrant: palette.LightVibrant ? rgbToHex(palette.LightVibrant.rgb) : null,
