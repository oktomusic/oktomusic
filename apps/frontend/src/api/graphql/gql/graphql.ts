...
export type SearchMyPlaylistsQuery = { __typename: 'Query', searchMyPlaylists: Array<{ __typename: 'PlaylistBasic', id: string, name: string, description: string | null, visibility: PlaylistVisibility, creator: { __typename: 'PlaylistCreator', id: string, username: string } }> };
...
export type UserProfileQuery = { __typename: 'Query', userProfile: { __typename: 'User', id: string, username: string, role: Role, sex: Sex | null, createdAt: Date, updatedAt: Date, playlists: Array<{ __typename: 'PlaylistBasic', id: string, name: string, description: string | null, visibility: PlaylistVisibility, creator: { __typename: 'PlaylistCreator', id: string, username: string } }> | null } };
