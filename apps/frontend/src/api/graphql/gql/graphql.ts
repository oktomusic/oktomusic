...
export type AlbumQuery = { __typename?: 'Query', album: { __typename?: 'Album', id: string, name: string, date?: any | null, artists: Array<{ __typename?: 'Artist', id: string, name: string }>, tracksByDisc: Array<Array<{ __typename?: 'Track', id: string, flacFileId?: string | null, name: string, trackNumber: number, discNumber: number, durationMs: number, artists: Array<{ __typename?: 'Artist', id: string, name: string }> }>> } };
