...
export type UserProfileQuery = { __typename: 'Query', userProfile: { __typename: 'User', id: string, username: string, role: Role, sex: Sex | null, createdAt: Date, updatedAt: Date } };
